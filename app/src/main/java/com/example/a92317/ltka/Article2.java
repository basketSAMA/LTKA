...
public class Article2 extends BaseActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        articleName.setText((String) this.getResources().getText(R.string.article2_name));
        articleAuthor.setText((String) this.getResources().getText(R.string.article2_author));
        articleContents.setText((String) this.getResources().getText(R.string.article2_contents));
