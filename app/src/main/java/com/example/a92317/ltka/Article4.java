...
public class Article4 extends BaseActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        articleName.setText((String) this.getResources().getText(R.string.article4_name));
        articleAuthor.setText((String) this.getResources().getText(R.string.article4_author));
        articleContents.setText((String) this.getResources().getText(R.string.article4_contents));
