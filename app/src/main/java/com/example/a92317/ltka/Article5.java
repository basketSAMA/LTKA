...
public class Article5 extends BaseActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        articleName.setText((String) this.getResources().getText(R.string.article5_name));
        articleAuthor.setText((String) this.getResources().getText(R.string.article5_author));
        articleContents.setText((String) this.getResources().getText(R.string.article5_contents));
