...
public class Article6 extends BaseActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        articleName.setText((String) this.getResources().getText(R.string.article6_name));
        articleAuthor.setText((String) this.getResources().getText(R.string.article6_author));
        articleContents.setText((String) this.getResources().getText(R.string.article6_contents));
