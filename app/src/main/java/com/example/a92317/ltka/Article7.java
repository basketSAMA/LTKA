...
public class Article7 extends BaseActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        articleName.setText((String) this.getResources().getText(R.string.article7_name));
        articleAuthor.setText((String) this.getResources().getText(R.string.article7_author));
        articleContents.setText((String) this.getResources().getText(R.string.article7_contents));
